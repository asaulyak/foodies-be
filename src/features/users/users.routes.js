...
userRouter.post('/signup', validateBodyMiddleware(userRegisterSchema), userControllers.registerUser);
userRouter.post('/signin', validateBodyMiddleware(userLoginSchema), userControllers.loginUser);
userRouter.get('/current', authMiddleware, userControllers.getCurrent);
